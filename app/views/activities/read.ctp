...
<script type="text/javascript">
    $(function(){
       ...
       //  $('#loading').show();
        ...
        $('#ActivityReadForm .submit').click(function(){
          $('#loading').show();
           $.ajax({
               type: "POST",
               url: $('#ActivityReadForm').attr('action'),
               data: $('#ActivityReadForm').serialize(),
...
<div id="loadingxxx" style=" bottom: 9px;  display: block; position: absolute;"><div id="loading" >...</div></div>
<div class="activities index">
    ...
    <div id="acciones" style="padding: 10px 0px 0">
        <?php
        echo $this->Form->create('Activity', array('action' => 'read'));
