            ...
            <div id="main">
                ...
                <div id="header">
                    <ul class="menu_header">
                        <li>
                            <?php echo $html->link("Como funciona", "/pages/howto") ?>
                        </li>
                        <li>
                            <?php echo $html->link("Planes", "/pages/plans") ?>
                        </li>
                        <li>
                            <?php echo $html->link("Registro", "/clients/register") ?>
                        </li>
                        <li>
                            <?php echo $html->link("Contacto", "/pages/contact") ?>
                        </li>
                    </ul>
                ...
                <div id="footer">
                    <div class="redes_sociales">
                        <ul class="link_terminos">
                            <li>
                                <?php echo $this->Html->link('T&eacute;rminos y condiciones', array('controller'=>'pages', 'action'=>'terms_and_conditions'), array('escape' => false, 'class' => "more align-right", 'title' => 'T&eacute;rminos y condiciones')); ?>
                            </li>
                            <li class="last">
                                <?php echo $this->Html->link('Pol&iacute;ticas de privacidad', array('controller'=>'pages', 'action'=>'privacy_policy'), array('escape' => false, 'class' => "more align-right", 'title' => 'Pol&iacute;ticas de privacidad')); ?>
                            </li>
                        </ul>
                        <div>
